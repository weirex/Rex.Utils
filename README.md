...
## 目录
* 更新日志（2020.12.10）
* [1.读取 `appsettings.json`](#appsettings.json)
* [2.Convert 类型转换](#Convert)
* [3.Linq 扩展](#Linq)
* [4.加密](#加密)
* 5.系统方法扩展
* 6.验证与判断
...
#### .Net Core 支持泛型 `AppSettings.GetAppSettings<T>( key, path )`
- 可继承基类进行扩展
...
## 2. Convert 类型转换
- [1.Boolean](#Boolean)
- [2.DataTable 与 List 转换](#TableToList)
